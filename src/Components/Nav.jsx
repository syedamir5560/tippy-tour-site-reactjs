            ...
            <nav className="bg-gray-800 rounded top-5 mx-[2%] left-0 w-[95%] fixed navbarshadow" >
                ...
                <div className={`${isOpen ? 'block' : 'hidden'} md:hidden z:20  `} id="mobile-menu" >
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 text-center mobile z-10">
                        ...
                        <NavLink to="/service" activeClassName="text-white" className=" text-[1.2rem] text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium"><i class="fa-solid fa-briefcase mx-2"></i>Services</NavLink>
