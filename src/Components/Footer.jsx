                ...
                <div className="grid grid-cols-1 items-center md:grid-cols-4 gap-10">
                    <div className="md:col-span-3 md:flex md:justify-between md:mb-4">
                        <div className='sm-mb-5'>
                            <h3 className="text-xl md:text-2xl font-semibold mb-2">Project</h3>
                        ...
                        <div className='sm-mb-5'    >
                            <h3 className="text-xl md:text-2xl font-semibold mb-2 ">Help</h3>
                            <ul className="list-none">
                    ...
                    <div className="text-center md:text-left">
                        <h1 className="text-3xl md:text-5xl  font-bold mb-4">Trippy</h1>
                        <h2 className="text-lg md:text-2xl mb-4 font-bold">Choose your favorite destination</h2>
