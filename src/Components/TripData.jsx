...
function TripData(props) {
  return (
    ...
    <h1 className="text-4xl font-bold mb-8 text-center">{props.h1}</h1>
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
                <h2 className="text-xl font-bold mb-4">{props.trip1}</h2>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
                <h2 className="text-xl font-bold mb-4">{props.trip2}</h2>
                <p className="text-gray-700">{props.para}</p>
            </div>
        </div>
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
                <h2 className="text-xl font-bold mb-4">{props.trip3}</h2>
                <p className="text-gray-700">{props.para}</p>
            </div>
        </div>
    </div>
