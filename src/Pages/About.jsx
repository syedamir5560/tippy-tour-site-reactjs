  ...
  return (
    <>
      ...
      <div className="container mx-auto p-8">
        <h1 className="text-5xl font-bold mb-8 font-serif text-center ">About Us</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <img src="https://images.unsplash.com/photo-1464037866556-6812c9d1c72e?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="About Us" className="w-full h-auto mb-4 md:mb-0 rounded-2xl" />
          </div>
          <div>
