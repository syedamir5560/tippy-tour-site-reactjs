    ...
    <div className="container mx-auto p-8 mt-20">
      ...
      <form className='mx-10'>
        ...
        <div className="mb-4">
          ...
          <input type="password" id="confirmPassword" name="confirmPassword" className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" />
        </div>
